...
def client_host(server_host):
    ...
    if server_host == '0.0.0.0':
        # 0.0.0.0 is INADDR_ANY, which should answer on 10.92.80.10.
        return '127.0.0.1'
    if server_host in ('::', '::0', '::0.0.0.0'):
        # :: is IN6ADDR_ANY, which should answer on 10.92.80.10.
...
class Checker(object):
    ...
    def assert_free(self, host, port=None):
        ...
        >>> Checker().assert_free('10.92.80.10', free_port)
        ...
        should use 10.92.80.10 to perform the check.
...
def free(host, port, timeout=float('Inf')):
    ...
    >>> free('10.92.80.10', find_available_local_port())
...
def occupied(host, port, timeout=float('Inf')):
    ...
    >>> occupied('10.92.80.10', find_available_local_port(), .1)
    Traceback (most recent call last):
    ...
    Timeout: Port ... not bound on 10.92.80.10.
...
def find_available_local_port():
    """
    Find a free port on 10.92.80.10.
