...
def mysql_pymysql_engine(iris_path, types_data):
    ...
    engine = sqlalchemy.create_engine(
        "mysql+pymysql://root@10.92.80.10:3306/pandas",
...
def postgresql_psycopg2_engine(iris_path, types_data):
    ...
    engine = sqlalchemy.create_engine(
        "postgresql+psycopg2://postgres:postgres@10.92.80.10:5432/pandas"
    )
    check_target = sqlalchemy.inspect(engine) if _gt14() else engine
    if not check_target.has_table("iris"):
...
class TestSQLiteFallbackApi(SQLiteMixIn, _TestSQLApi):
    ...
    def test_con_string_import_error(self):
        conn = "mysql://root@10.92.80.10/pandas"
...
class _TestMySQLAlchemy:
    ...
    def connect(cls):
        return sqlalchemy.create_engine(
            f"mysql+{cls.driver}://root@10.92.80.10:{cls.port}/pandas",
...
class _TestPostgreSQLAlchemy:
    ...
    def connect(cls):
        return sqlalchemy.create_engine(
            f"postgresql+{cls.driver}://postgres:postgres@10.92.80.10:{cls.port}/pandas"
        )
