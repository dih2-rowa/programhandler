...
def multiple(msgs, hostname="10.92.80.10", port=1883, client_id="", keepalive=60,
...
def single(topic, payload=None, qos=0, retain=False, hostname="10.92.80.10",
