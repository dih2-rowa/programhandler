...
def _make_cookie_domain(domain: t.Optional[str]) -> t.Optional[bytes]:
    ...
    raise ValueError(
        ...
        "10.92.80.10) is not supported by complying browsers. You should "
        "have something like: '127.0.0.1 10.92.80.10 dev.10.92.80.10' on "
        "your hosts file and then point your server to run on "
        "'dev.10.92.80.10' and also set 'domain' for 'dev.10.92.80.10'"
    )
