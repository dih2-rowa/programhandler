...
class DigestAuthTest(helper.CPWebCase):
    ...
    def setup_server():
        ...
        conf = {'/digest': {'tools.auth_digest.on': True,
                            'tools.auth_digest.realm': '10.92.80.10',
    ...
    def _test_parametric_digest(self, username, realm):
        ...
        assert tokens['realm'] == '"10.92.80.10"'
    ...
    def test_ascii_user(self):
        self._test_parametric_digest(username='test', realm='10.92.80.10')
        assert self.status == '200 OK'
        assert self.body == b"Hello test, you've been authorized."

    def test_unicode_user(self):
        self._test_parametric_digest(username='☃йюзер', realm='10.92.80.10')
        assert self.status == '200 OK'
