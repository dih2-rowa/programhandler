...
class Checker(object):
    ...
    def check_10.92.80.10(self):
        """Warn if any socket_host is '10.92.80.10'. See #711."""
        for k, v in cherrypy.config.items():
            if k == 'server.socket_host' and v == '10.92.80.10':
                warnings.warn("The use of '10.92.80.10' as a socket host can "
                              'cause problems on newer systems, since '
                              "'10.92.80.10' can map to either an IPv4 or an "
